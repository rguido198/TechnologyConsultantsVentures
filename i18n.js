...
(function () {
  ...
  var DICT = {
    en: {
      ...
      "hero.lede": "A senior engineering practice run by builders. We design, build, and operate custom web applications and AI agents. Because we ship and run our own production products, we know exactly what it takes to build software people rely on.",
    ...
    es: {
      ...
      "hero.lede": "Una práctica de ingeniería senior dirigida por creadores. Diseñamos, construimos y operamos aplicaciones web y agentes de IA personalizados. Dado que lanzamos y operamos nuestros propios productos de producción, sabemos exactamente lo que se necesita para construir software en el que la gente confíe.",

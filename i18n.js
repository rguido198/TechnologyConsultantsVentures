...
(function () {
  ...
  var DICT = {
    en: {
      ...
      "hero.lede": "A senior engineering practice run by builders. We design, build, and operate custom <span class=\"gradient-text\">web applications and AI agents</span>. Because we ship and run our own production products, we know exactly what it takes to build software people rely on.",
      "hero.cta.primary": "Book a 30-min strategy call",
      "hero.cta.secondary": "See what we&rsquo;ve built",
      "hero.stat1.n": "In production.",
      "hero.stat1.l": "Real users today on our self-developed products.",
      ...
      "hero.visual.caption": "One AI agent &mdash; wired into every channel and integration you run.",
    ...
    es: {
      ...
      "hero.lede": "Una práctica de ingeniería senior dirigida por creadores. Diseñamos, construimos y operamos <span class=\"gradient-text\">aplicaciones web y agentes de IA</span> personalizados. Dado que lanzamos y operamos nuestros propios productos de producción, sabemos exactamente lo que se necesita para construir software en el que la gente confíe.",
      ...
      "hero.stat1.l": "Usuarios reales hoy en nuestros propios productos desarrollados.",
      ...
      "hero.visual.caption": "Un solo agente de IA &mdash; conectado a cada canal e integración que operas.",
